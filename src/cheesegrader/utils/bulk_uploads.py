"""Quercus Bulk Uploading Utilities.

This module provides a set of tools for bulk uploading grades and files to a Quercus assignment.
...
__all__ = ["UploadMode", "upload_files", "upload_grades"]
